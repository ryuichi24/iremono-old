...
export const CreateCryptoFolderForm = ({ open, handleClose }: Props) => {
  const [encryptionKey, setEncryptionKey] = useState('');
  const { setClientEncryptionKey, setHasCryptoFolder } = useAuthActions();
  ...
  const handleSubmit: React.MouseEventHandler<HTMLButtonElement> = (e) => {
    ...
    foldersService
      .createRootFolder({ encryptionKey, folderType: 'crypto' })
      .then((result) => {
